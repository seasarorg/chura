CREATE TABLE EMP(ID NUMERIC(8,0) NOT NULL PRIMARY KEY, EMPNO NUMERIC(4,0) NOT NULL ,ENAME VARCHAR(20),MGRID NUMERIC(8,0),HIREDATE DATE,SAL NUMERIC(7,2),DEPTID NUMERIC(8,0), VERSIONNO NUMERIC(8,0));
CREATE TABLE DEPT(ID NUMERIC(8,0) NOT NULL PRIMARY KEY, DEPTNO NUMERIC(2,0) NOT NULL,DNAME VARCHAR(20),LOC VARCHAR(20), VERSIONNO NUMERIC(8,0));
