...
public abstract class ComponentsChild implements Comparable<ComponentsChild> {
	...
	private static List<Class<? extends ComponentsChild>> priority
			= new ArrayList<Class<? extends ComponentsChild>>();
	...
	public int compareTo(ComponentsChild o) {
		return priority.indexOf(this.getClass()) - priority.indexOf(o.getClass());
	}
