package examples.chura.web.emp {
	...
	public class EmpRegistPage extends AbstractPage {
		...
		// 2.0.1ではimportとパッケージがかぶってたらエラーが起こる
		// しかも、クラスとかぶってもダメ
		...
		*/
		public function createOnClick(event: Event): void {
			var empEdit: EmpEdit = EmpEdit(PopUpManager.createPopUp(document as EmpRegist, EmpEdit, true));
			empEdit.page.parentObject = document;
		}
