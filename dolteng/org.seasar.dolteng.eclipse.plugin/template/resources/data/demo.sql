CREATE TABLE EMP(ID NUMERIC(8) NOT NULL PRIMARY KEY, EMPNO NUMERIC(4) NOT NULL ,ENAME VARCHAR(20),MGRID NUMERIC(8),HIREDATE DATE,SAL NUMERIC(7,2),DEPTID NUMERIC(8), VERSIONNO NUMERIC(8));
CREATE TABLE DEPT(ID NUMERIC(8) NOT NULL PRIMARY KEY, DEPTNO NUMERIC(2) NOT NULL,DNAME VARCHAR(20),LOC VARCHAR(20), VERSIONNO NUMERIC(8));
