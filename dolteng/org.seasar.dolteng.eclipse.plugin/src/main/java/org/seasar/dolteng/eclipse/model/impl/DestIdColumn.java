 ...
 * 
 */
public class DestIdColumn implements ColumnDescriptor {

    private static final String NAME = ClassUtil
            .getShortClassName(DestIdColumn.class);

    private CellEditor editor;

    public DestIdColumn(Table table) {
        this.editor = new TextCellEditor(table);
        TableColumn column = new TableColumn(table, SWT.NONE);
        column.setText(Labels.COLUMN_MODEL_ID);
        column.setWidth(150);
