 ...
 * 
 */
public class DynamicPropertyValueColumn implements ColumnDescriptor {

    private static final String NAME = ClassUtil
            .getShortClassName(DynamicPropertyValueColumn.class);
    ...
    public void setValue(Object element, Object value) {
        if (element instanceof DynamicPropertyRow) {
            DynamicPropertyRow row = (DynamicPropertyRow) element;
            if (value != null && StringUtil.isEmpty(value.toString()) == false) {
