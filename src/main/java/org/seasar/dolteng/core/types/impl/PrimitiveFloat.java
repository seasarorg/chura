 ...
 * 
 */
public class PrimitiveFloat implements TypeMapping {

    private static final int[] SQL_TYPES = new int[] { Types.REAL, Types.FLOAT };

    private static final String[] SQL_TYPENAMES = { "REAL", "FLOAT" };
