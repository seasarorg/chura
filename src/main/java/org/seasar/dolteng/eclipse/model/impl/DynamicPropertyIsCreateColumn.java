 ...
 * 
 */
public class DynamicPropertyIsCreateColumn implements ColumnDescriptor {

    private static final String NAME = ClassUtil
            .getShortClassName(DynamicPropertyIsCreateColumn.class);
    ...
    public Image getImage(Object element) {
        if (element instanceof DynamicPropertyRow) {
            DynamicPropertyRow row = (DynamicPropertyRow) element;
            return row.isCreate() ? Images.CHECKED : Images.UNCHECKED;
        }
    ...
    public Object getValue(Object element) {
        if (element instanceof DynamicPropertyRow) {
            DynamicPropertyRow row = (DynamicPropertyRow) element;
            return Boolean.valueOf(row.isCreate());
        }
    ...
    public void setValue(Object element, Object value) {
        if (element instanceof DynamicPropertyRow) {
            DynamicPropertyRow row = (DynamicPropertyRow) element;
            row.setCreate(((Boolean) value).booleanValue());
        }
    }
